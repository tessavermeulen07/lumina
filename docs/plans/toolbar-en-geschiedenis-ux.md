...
- `src/lib/insights/week-navigation.ts`
- `src/components/features/journal/WritingToolbar.tsx`
- `src/components/ui/ConfirmDialog.tsx`
- `src/components/features/journal/SetPrivateDialog.tsx`
- `src/components/features/journal/UnlockPrivateEntryDialog.tsx`
- `src/lib/entries/toggle-entry-flags.ts`
- `src/lib/entries/unlock-private-entry.ts`
- `src/app/(app)/bewaard/page.tsx`
