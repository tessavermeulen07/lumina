...
todos:
  - id: serif-font
    ...
    status: completed
  - id: button-component
    content: Create src/components/ui/Button.tsx with primary, outline, dark variants
    status: completed
  - id: marketing-components
    content: "Build marketing components: Header, Hero, HeroIllustration, FeatureGrid, Footer"
    status: completed
  - id: marketing-route
    content: Create src/app/(marketing)/layout.tsx and page.tsx; remove src/app/page.tsx
    status: completed
  - id: save-plan
    content: Save plan to docs/plans/lumina-landing-page.md
    status: completed
isProject: true
---
...
- [`src/app/page.tsx`](src/app/page.tsx) removed; [`src/app/(marketing)/page.tsx`](src/app/(marketing)/page.tsx) serves `/`.
...
### Palette usage (from [`src/app/globals.css`](src/app/globals.css))
...
Mockup uses serif headlines. Google Font in [`src/app/layout.tsx`](src/app/layout.tsx):
...
In [`src/app/(marketing)/layout.tsx`](src/app/(marketing)/layout.tsx) via `.marketing-aura` in globals.css:
...
Single component in [`src/components/ui/Button.tsx`](src/components/ui/Button.tsx):
...
1. Add serif font to [`src/app/layout.tsx`](src/app/layout.tsx) and `--font-serif` in [`src/app/globals.css`](src/app/globals.css)
2. Create [`src/components/ui/Button.tsx`](src/components/ui/Button.tsx)
3. Build marketing components (`Header`, `Hero`, `HeroIllustration`, `FeatureCard`, `FeatureGrid`, `Footer`)
4. Create [`src/app/(marketing)/layout.tsx`](src/app/(marketing)/layout.tsx) with aura background
5. Create [`src/app/(marketing)/page.tsx`](src/app/(marketing)/page.tsx) composing all sections
6. Remove [`src/app/page.tsx`](src/app/page.tsx)
7. Save plan to [`docs/plans/lumina-landing-page.md`](lumina-landing-page.md)
