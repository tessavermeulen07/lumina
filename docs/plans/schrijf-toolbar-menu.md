...
De basis staat al in `src/components/features/journal/WritingArea.tsx`: hint + randloos textarea. Dit plan voegt een **sticky bottom toolbar** toe die zichtbaar wordt zodra `content.trim().length > 0`.
...
- Nieuw bestand: `src/components/features/journal/ImageUploadModal.tsx`
...
| Actie | Bestand |
|-------|---------|
| Nieuw | `src/components/features/journal/ToolbarIconButton.tsx` |
| Nieuw | `src/components/features/journal/ToolbarCarousel.tsx` |
| Nieuw | `src/components/features/journal/WritingToolbar.tsx` |
| Nieuw | `src/components/features/journal/ImageUploadModal.tsx` |
| Nieuw | `src/components/features/journal/WritingToolbarIcons.tsx` |
| Aanpassen | `src/components/features/journal/WritingArea.tsx` |

Geen wijzigingen aan `src/app/(app)/schrijf/page.tsx` nodig.
