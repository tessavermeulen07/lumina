...
export const insightsTagClass =
  "inline-flex rounded-full bg-neutral-100 px-2.5 py-1 text-xs font-medium text-foreground dark:bg-neutral-800";

export const insightsPrimaryThemeClass =
  "text-lg font-semibold text-lumina-500 dark:text-lumina-300";
